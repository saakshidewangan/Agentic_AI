...
agent = Agent(
    model=Groq(
        id="mixtral-8x7b-32768"  # Mistral model through Groq
    ),
    tools=[DuckDuckGo()],
...
def analyze_image_and_search(image_url: str, query: str):
    """
    Analyze image and search for additional content using Groq and DuckDuckGo.
...
if __name__ == "__main__":
    ...
    image_url = (
        ...
        "Kalinga_Institute_of_Industrial_Technology#/media/"
        "File:Kiit_library_building.jpg"
    )
